...
Foreword:
---------
This "recipe" was written for the 'bookworm' RPi OS distro. Consequently, its relevance is fading. In my case, 
I have recently upgraded my RPi 3A+ system from 'bookworm' to 'trixie' (ref 'In-Place Upgrade UR' below). 
The (mostly) positive experience from that in-place upgrade is that the Bluetooth functionality survived the upgrade! 
...
"fresh" 'trixie' install, but again I'll likely update/refresh/revise (or rewrite) this recipe after doing a fresh 
