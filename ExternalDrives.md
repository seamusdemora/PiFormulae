# How To Connect a [USB Flash Drive](https://en.wikipedia.org/wiki/USB_flash_drive) to Raspberry Pi?  
...
3. [USB flash drives](https://en.wikipedia.org/wiki/USB_flash_drive) are cheap
