...
4.  [The Linux USB Input Subsystem, Part I](https://www.linuxjournal.com/article/6396)
5.  [Using the Input Subsystem, Part II, The Linux Journal](https://www.linuxjournal.com/article/6429) 
6.  [Mouse Events and Input Event Interface in Linux](https://www.baeldung.com/linux/mouse-events-input-event-interface) 
7.  [`evdev` - Wikipedia](https://en.wikipedia.org/wiki/Evdev) 
8.  [Linux kernel interfaces - Wikipedia](https://en.wikipedia.org/wiki/Linux_kernel_interfaces#Linux_API) 
9.  [Linux input ecosystem, by Joe Shaw](https://www.joeshaw.org/linux-input-ecosystem/) 
10.  [evdev - Generic Linux Input driver - archlinux](https://man.archlinux.org/man/evdev.4) 
11.  [Keyboard input - archlinux](https://wiki.archlinux.org/title/Keyboard_input) 
12.  [Python: evdev](https://pypi.org/project/evdev/)
13.  [What is evsieve?](https://github.com/KarsMulder/evsieve) 
14.  [Writing My Own Keyboard Driver](https://dev.to/frosnerd/writing-my-own-keyboard-driver-16kh) 
15.  [Creating an input device driver - Linux Kernel docs](https://www.kernel.org/doc/html/latest/input/input-programming.html) 
